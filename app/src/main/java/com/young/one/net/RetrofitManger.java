...
import com.young.one.utilcode.util.NetworkUtils;
...
public class RetrofitManger {
    ...
    private static String BASE_URL = "http://v3.wufazhuce.com:8000";
...
//    public static final int CACHE_STALE_LONG = 120;
    ...
    private static class LoggingInterceptor implements Interceptor {
        ...
        public Response intercept(Chain chain) throws IOException {
            ...
            Log.i("jk_business_net", String.format("Sending request %s on %s%n%s",
            ...
            Log.i("jk_business_net", String.format("Received response for %s in %.1fms%n%s",
